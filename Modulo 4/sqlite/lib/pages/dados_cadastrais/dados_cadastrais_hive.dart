...
import 'package:trilhaapp_inicial/repositories/dados_cadastrais_repository.dart';
...
class _DadosCadastraisHivePageState extends State<DadosCadastraisHivePage> {
  ...
  var linguagensRepository = LangRepository();
  var niveis = [];
  var linguagens = [];
  bool salvando = false;
  ...
  @override
  void initState() {
    niveis = nivelRepository.returnLevel();
    linguagens = linguagensRepository.returnLang();
    super.initState();
    carregarDados();
  }
