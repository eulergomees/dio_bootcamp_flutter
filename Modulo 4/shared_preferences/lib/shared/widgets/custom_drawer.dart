...
import 'package:trilhaapp_inicial/pages/config_page.dart';
import 'package:trilhaapp_inicial/pages/login_page.dart';
import 'package:trilhaapp_inicial/pages/random_number_page.dart';
          ...
          InkWell(
            ...
            onTap: () {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext) => const ConfigPage()));
            },
          ),
          const Divider(),
          const SizedBox(
          ...
          InkWell(
            ...
            onTap: () {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext) => const RandomNumberPage()));
            },
          ),
          const Divider(),
          const SizedBox(
